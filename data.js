...
const data = [
    ...
    { user: 'nam_tran', item: 'ao_phong_den', rating: 5 },
    ...
    { user: 'quang_nguyen', item: 'giay_the_thao', rating: 4 },
    { user: 'quang_nguyen', item: 'giay_chay_bo', rating: 5 },
    { user: 'quang_nguyen', item: 'tui_xach', rating: 2 },
    { user: 'quang_nguyen', item: 'ao_phong_trang', rating: 2 },
    { user: 'mai_tran', item: 'giay_the_thao_trang', rating: 3 },
    { user: 'mai_tran', item: 'giay_the_thao_xanh', rating: 4 },
    { user: 'mai_tran', item: 'giay_da_bong_xanh', rating: 4 },
    ...
    { user: 'thanh_nguyen', item: 'giay_da_bong_do', rating: 5 },
    { user: 'thanh_nguyen', item: 'giay_the_thao_trang', rating: 5 },
    { user: 'thanh_nguyen', item: 'giay_chay_bo', rating: 5 },
    ...
    { user: 'hong_le', item: 'giay_the_thao_xanh', rating: 4 },
    ...
    { user: 'tuan_truong', item: 'tui_xach_to', rating: 5 },
    ...
    { user: 'anh_vu', item: 'tui_xach_to', rating: 4 },
    { user: 'anh_vu', item: 'balo_nho', rating: 3 },
    { user: 'anh_vu', item: 'non_snapback', rating: 4 },
    ...
    { user: 'hoang_nguyen', item: 'tui_xach', rating: 5 },
